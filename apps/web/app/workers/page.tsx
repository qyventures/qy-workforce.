...
export default function WorkersPage() {
  ...
  return <main style={{minHeight:'100vh',background:'#F9FAFB'}}><SiteHeader />
    ...
    <form onSubmit={submit} style={{display:'grid',gap:14}}>
      ...
      {state==='error' && <p role="alert" style={{color:'#B42318',margin:0}}>We could not submit your interest. Please check the required fields and try again.</p>}
    </form></>}</div>
