...
'Blocks worker-app clock-in unless the assigned worker still satisfies live identity, residency, work-eligibility, vetting, training, role and current-consent prerequisites. Clock-out is intentionally not blocked by later expiry/revocation.';
