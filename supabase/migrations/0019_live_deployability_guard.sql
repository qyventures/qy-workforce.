...
-- Keep the mobile readiness summary aligned with the same authoritative rules used
-- at shift discovery/acceptance boundaries.
...
-- Re-issue discovery using the same live deployability predicate.
...
-- Re-issue acceptance so live readiness is checked inside the serialized transaction.
