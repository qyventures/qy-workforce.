...
begin
  ...
  -- The trigger function intentionally runs as invoker; it is an invariant, not an
  -- authorization bypass. SECURITY DEFINER here would unnecessarily enlarge privilege.
...
-- Static definition checks ensure all payroll/margin basis columns remain protected.
do $$
declare
  v_def text;
begin
