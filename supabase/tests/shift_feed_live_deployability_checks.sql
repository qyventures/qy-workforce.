-- Structural regression checks for migration 0025.
-- These tests are intentionally credential-free and validate that discovery keeps
...
-- The worker feed is callable only by authenticated users, not anon/public.
do $$
begin
