...
export const metadata: Metadata = { title: 'How it works', description: 'See how QY Workforce supports staffing, worker readiness, attendance and timesheet workflows.', alternates: { canonical: '/how-it-works' } };
...
export default function HowItWorks() {
  return <main style={{minHeight:'100vh',background:'#0B1220',color:'#fff'}}>
    <SiteHeader /><section style={{maxWidth:1050,margin:'0 auto',padding:'72px 24px'}}>
