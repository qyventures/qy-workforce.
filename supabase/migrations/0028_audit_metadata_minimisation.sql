...
grant execute on function public.audit_metadata_contains_sensitive_keys(jsonb) to authenticated, service_role;
...
-- A constraint trigger is intentionally avoided: fail immediately in the same statement
-- that attempts to copy sensitive evidence into the audit log.
