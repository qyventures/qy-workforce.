...
The detector and trigger functions are owner-only implementation details; authenticated clients do not receive direct EXECUTE permission. This keeps the callable database surface smaller while preserving enforcement through the trigger.
