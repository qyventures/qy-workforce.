...
export const metadata: Metadata = { title: 'Staffing industries', description: 'Flexible manpower support for hospitality, F&B, cleaning, retail, promotions and events.', alternates: { canonical: '/industries' } };
...
export default function Industries() {
  return <main style={{minHeight:'100vh',background:'#F7F8FB',color:'#101828'}}>
    <SiteHeader /><section style={{maxWidth:1080,margin:'0 auto',padding:'64px 24px'}}>
